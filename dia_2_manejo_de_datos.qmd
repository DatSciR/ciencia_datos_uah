...
<table>
  <tr>
    ...
    <td style="vertical-align:middle;">
      <p style="margin:0 0 6px 0;">**CUISINE**</p>
      <p style="margin:0 0 6px 0;">El dataset de **Cuisine** de TidyTuesday recopila información sobre recetas y tipos de cocina (origen, valor nutricional, tiempo de preparación etc.) </p>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    ...
    <td style="vertical-align:middle;">
      <p style="margin:0 0 6px 0;">**PIXAR**</p>
      <p style="margin:0 0 6px 0;">El dataset de **Pixar** en TidyTuesday recopila información detallada sobre las películas de Pixar, incluyendo variables de producción, taquilla y crítica.</p>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    ...
    <td style="vertical-align:middle;">
      <p style="margin:0 0 6px 0;">**MSLEEP**</p>
      <p style="margin:0 0 6px 0;">El dataset **msleep** contiene información sobre **el sueño de distintos** mamíferos. Incluye variables biológicas, ecológicas y taxonómicas, así como medidas relacionadas con sus patrones de sueño</p>
    </td>
  </tr>
</table>
...
🐧Selecciona los pinguinos que tengan picos de más de 40mm (bill_len) y que pesen menos de 4.5kg (recuerda que puedes ver más información de tu dataset en ?penguins)

🐧De los datos filtrados conserva únicamente las columnas species, island, bill_length, bill_depth y body_mass

🐧Añade una columna llamada bill_ratio que calcule la relación entre longitud y profundidad del pico

🐧Une el resultado con el dataset islands \_info, de forma que cada pingüino quede asociado a si su isla es un área protegida.
...
🐧(EXTRA) Responde a las siguientes preguntas: ¿Cual es la máxima relación entre longitud y profundidad del pico de los individuos en zonas protegidas? ¿y no protegidas? ¿Cuanto pesa el individuo más pesado?
